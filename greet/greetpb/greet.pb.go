...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	0x80, 0xf2, 0x8c, 0x5c, 0xa0, 0xb6, 0x04, 0x17, 0xa5, 0x96, 0x65, 0x26, 0xa7, 0x0a, 0x99, 0x70,
	...
	0x00, 0xff, 0xff, 0x22, 0x03, 0xf7, 0xdb, 0x29, 0x01, 0x00, 0x00,
}
...
// GreetSreviceClient is the client API for GreetSrevice service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type GreetSreviceClient interface {
	Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
}

type greetSreviceClient struct {
	cc *grpc.ClientConn
}

func NewGreetSreviceClient(cc *grpc.ClientConn) GreetSreviceClient {
	return &greetSreviceClient{cc}
}

func (c *greetSreviceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetSrevice/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// GreetSreviceServer is the server API for GreetSrevice service.
type GreetSreviceServer interface {
	Greet(context.Context, *GreetRequest) (*GreetResponse, error)
}

// UnimplementedGreetSreviceServer can be embedded to have forward compatible implementations.
type UnimplementedGreetSreviceServer struct {
}

func (*UnimplementedGreetSreviceServer) Greet(ctx context.Context, req *GreetRequest) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Greet not implemented")
}

func RegisterGreetSreviceServer(s *grpc.Server, srv GreetSreviceServer) {
	s.RegisterService(&_GreetSrevice_serviceDesc, srv)
}

func _GreetSrevice_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetSreviceServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetSrevice/Greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetSreviceServer).Greet(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _GreetSrevice_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greet.GreetSrevice",
	HandlerType: (*GreetSreviceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Greet",
			Handler:    _GreetSrevice_Greet_Handler,
		},
	},
